...
class AutoCrawler:
    ...
    @staticmethod
    def get_keywords(keywords_file=r"src\tools\image_crawler\keywords.txt"):
...
if __name__ == '__main__':
    ...
    print(
        'Options - skip:{}, threads:{}, google:{}, full_resolution:{}, face:{}, no_gui:{}, limit:{}, _proxy_list:{}'
            .format(_skip, _threads, _google, _full, _face, _no_gui, _limit, _proxy_list))
